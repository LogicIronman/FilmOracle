...
public class AnalysisService {
    ...
    private static final Set<String> GENERIC_KEYWORDS = Set.of(
            ...
            "这部", "一片", "看了", "看完", "看了", "觉得", "一种", "一些", "这种", "那种",
            "觉得", "感觉", "这部", "一片", "这种", "那种", "什么", "怎么", "为什么", "怎么样",
            "一个", "两个", "三个", "他们", "我们", "你们", "自己", "别人", "大家", "所有",
            "一直", "已经", "还是", "或者", "而且", "然后", "后来", "最后", "开始", "出现",
            "这是", "那是", "还有", "如果", "虽然", "不过", "其实", "就是", "这样", "那样",
            "不得", "不到", "不是", "不会", "不能", "不要", "不用", "不行", "没有", "无关",
            "一些", "很多", "很少", "非常", "特别", "确实", "比较", "相对", "一般", "普通",
            "好看", "不好", "不错", "还行", "一般", "太差", "太好", "说是", "来说", "对于",
            "这部", "那种", "什么", "这部", "这是", "那是", "还有", "因为", "所以", "但是"
    );
