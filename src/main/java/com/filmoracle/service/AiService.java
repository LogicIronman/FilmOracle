...
public class AiService {
    ...
    public static final String DEFAULT_PROMPT = """
        ...
        5. 关键词：
        关键词必须来自评论中的经典总结词语或高频短语，至少输出25个。避免"剧情、演技、画面"等通用词。关键词应尽量体现这部电影独有的讨论点，例如具体场景名、人物关系、叙事结构、情绪体验、争议桥段、视听特征等。
        ...
        - polarity：-5.0到5.0，负值=差评，正值=好评，精度到0.1
        - intensity：0.0到5.0，0=平淡，5=强烈情绪，精度到0.1
        - votes：该点聚合的相似评论数量（有多少条评论对该方面表达了相近的情感，不是点赞数）。votes必须反映该方面情感相似评论的实际数量，不能全填0或1。votes越大代表越多观众持相同看法，点会越大。
        - text：代表性评论原文摘录，最多60字（选点赞最多或最具代表性的评论）
        至少输出30条scatter，评论数量多时应输出更多（50条以上为佳）。每个方面都应有至少1个点。确保散点覆盖4个象限，不要全挤在一处。反讽按真实情感打分。如果评论中提到某个方面超过3次，该方面的scatter点votes应大于1。
        ...
        输出 JSON 格式：
        {
          ...
          "scatter": [{"aspect": "方面", "polarity": -5.0到5.0, "intensity": 0.0到5.0, "votes": 聚合评论数, "text": "评论摘录"}],
          "emotionMap": {
            "quadrants": [
